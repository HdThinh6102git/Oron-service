...
export class migration1697952199565 implements MigrationInterface {
  name = 'migration1697952199565';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying NOT NULL, "password" character varying NOT NULL, "name" character varying NOT NULL, "full_address" text NOT NULL, "specific_address" text NOT NULL, "phone_number" character varying NOT NULL, "email" character varying NOT NULL, "profile_pic" character varying, "background_pic" character varying, "is_verify_phone" boolean NOT NULL DEFAULT false, "is_verify_email" boolean NOT NULL DEFAULT false, "status" character varying NOT NULL DEFAULT 'ACTIVE', "refresh_token" character varying, "last_login" TIMESTAMP, "email_verify_code" character varying, "verification_time" numeric, "phone_verify_code" character varying, "updated_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "role_id" integer, "province_id" character varying, "district_id" character varying, "ward_id" character varying, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
